  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={heroImage}
          alt="Long-distance car travel service across Maharashtra"
      ...
      <div className="container relative z-10 py-20 md:py-32">
        <div className="max-w-2xl animate-fade-in">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-cream leading-tight mb-6">
            Safe & Comfortable{" "}
            <span className="text-amber">Long-Distance</span> Car Travel in Maharashtra
          </h1>
          <p className="text-lg md:text-xl text-cream/80 mb-8 leading-relaxed">
            SK Tours & Travels provides safe and comfortable long-distance and one-way car travel 
            services across Maharashtra. Reliable outstation trips with professional service, 
            clean vehicles, and flexible travel options.
          </p>
