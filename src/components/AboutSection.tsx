        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              <span className="text-primary">SK Tours & Travels</span> — Your Trusted Travel Partner
            </h2>
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              Welcome to SK Tours & Travels! We are professional long-distance travel experts with over 5 years 
              of experience on the road. We specialize in providing safe, comfortable, 
