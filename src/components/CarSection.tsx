...
import carImage from "@/assets/toyota-etios.jpg";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative">
              ...
              <img
                src={carImage}
                alt="Comfortable outstation car travel with Toyota Etios in Maharashtra"
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Travel in the <span className="text-accent">Toyota Etios</span>
            </h2>
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              The Toyota Etios is a reliable sedan known for its comfort, fuel efficiency, 
              and spacious interior. It's the perfect companion for your long-distance 
