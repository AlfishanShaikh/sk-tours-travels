      ...
      <div className="container">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 rounded-full bg-accent flex items-center justify-center">
                <span className="text-accent-foreground font-bold text-sm">SK</span>
              </div>
              <span className="font-bold text-xl text-cream">SK Tours & Travels</span>
            </div>
        ...
        <div className="border-t border-cream/10 pt-8">
          <p className="text-center text-cream/50 text-sm">
            © {currentYear} SK Tours & Travels. All rights reserved. | Available 24/7 for your travel needs.
          </p>
        </div>
      </div>
    </footer>
